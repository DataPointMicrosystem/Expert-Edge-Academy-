      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-white/50 leading-relaxed">
              Online learning that opens doors and creates lasting opportunities.
            </p>
          ...
          {[
            { heading: "Platform", links: ["Browse courses", "Categories", "Pricing", "Enterprise"] },
            { heading: "Instructors", links: ["Become an instructor", "Instructor handbook", "Revenue share", "Community"] },
            { heading: "Company", links: ["About us", "Careers", "Blog", "Press kit"] },
            { heading: "Support", links: ["Help center", "Accessibility", "Terms of use", "Privacy policy"] },
          ].map((col) => (
            <div key={col.heading}>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/30">
            © 2024 ExpertEdge Academy, Inc. All rights reserved.
          </p>
          <div className="flex items-center gap-1 bg-white/10 rounded-full px-3 py-1.5">
            ...
            <svg className="w-3 h-3 text-white/40 ml-1" viewBox="0 0 12 12" fill="currentColor">
