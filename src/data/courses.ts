...
export const COURSES = [
  ...
  },
  {
    ...
    badge: "Hot",
    description:
      "Master UI/UX design from scratch with Figma. Learn user research, wireframing, prototyping, and design systems used at top tech companies.",
    ...
    sections: [
      ...
      },
      {
        ...
        lectures: [
          ...
          {
            id: 6,
            title: "Frames, Groups, and Components",
            duration: "22:45",
            type: "video",
            free: false,
            completed: false,
  ...
  },
  {
    ...
    badge: "Bestseller",
    description:
      "Learn Python for Data Science, NumPy, Pandas, Matplotlib, Seaborn, Plotly, Scikit-Learn, Machine Learning, Tensorflow, and more!",
  ...
  },
  {
    ...
    badge: null,
    description:
      "Become a Digital Marketing expert covering SEO, Social Media, Email Marketing, Google Ads, Facebook Ads, and 18 more subjects.",
  ...
  },
  {
    ...
    badge: null,
    description:
      "Become a confident financial analyst using Excel, PowerPoint, and industry tools. Covers valuation, investing, and financial modeling.",
  ...
  },
  {
    ...
    badge: "New",
    description:
      "Learn photography from absolute beginner to advanced. Covers camera settings, composition, lighting, editing in Lightroom, and business skills.",
    ...
    requirements: [
      "Any camera (phone, DSLR, or mirrorless)",
...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: "I went from zero design skills to booking ₦7.5 million/month clients within six months. The UI/UX bootcamp is genuinely world-class.",
