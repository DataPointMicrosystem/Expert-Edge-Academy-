...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F9F8F5] flex">
      {/* Left — branding */}
      <div className="hidden lg:flex flex-col justify-between w-[45%] bg-linear-to-br from-deep-blue to-charcoal text-white p-12 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-linear-to-b from-deep-blue/60 to-deep-blue/95" />

        <div className="relative z-10">
          <Link to="/" className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-xl bg-primary-blue flex items-center justify-center shadow-lg">
              <svg
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button
                  type="button"
                  className="text-xs text-charcoal font-semibold hover:text-primary-blue transition-colors"
                >
                  Forgot password?
                </button>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-xl bg-charcoal text-white font-bold text-sm hover:opacity-90 transition-colors disabled:opacity-60 flex items-center justify-center gap-2 shadow-md mt-2"
            >
              {loading ? (
                <>
                  <svg
