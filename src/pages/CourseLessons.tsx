    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#1B1F3B]">
        <div className="text-center text-white">
          ...
          <Link to="/" className="text-[#F5A623] underline">
            ← Back to home
          </Link>
        </div>
      </div>
        ...
        >
            ...
            <div className="w-full h-full relative flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-white/60 text-xs">
                  Streaming access included with your enrollment
                </p>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-linear-to-t from-black/80 to-transparent p-3">
                ...
                <div className="flex items-center gap-3 text-white/80">
                  ...
                  <span className="text-xs">
                    4:22 / {currentLecture?.duration || "0:00"}
                  </span>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 bg-[#1B1F3B]">
              ...
              <button
                ...
                disabled={
                  ...
                  activeLecture ===
                    course.sections[activeSection].lectures.length - 1
                }
                className="flex items-center gap-2 text-xs font-semibold px-4 py-2 rounded-lg border border-white/20 hover:bg-white/10 transition-colors disabled:opacity-30"
              >
                Next
            ...
            <div className="px-4 border-b border-white/10 bg-[#13172b] flex gap-1">
              {(["overview", "notes", "qa", "resources"] as const).map(
                (tab) => (
                  <button
                    key={tab}
                ...
                <div className="flex flex-col gap-4">
                  <div className="bg-white/5 border border-white/10 rounded-xl p-5 text-center">
                    ...
                    <p className="text-sm text-white/60 mb-3">
                      Have a question? Ask the instructor or community.
                    </p>
              ...
              {activeTab === "resources" && (
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <div
                      key={r.name}
                      className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-4 py-3 hover:bg-white/10 transition-colors cursor-pointer"
                    >
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-1.5 mt-1">
                                ...
                                {lecture.free && (
                                  <span className="text-[9px] text-[#F5A623]/60 font-bold">
                                    FREE
                                  </span>
                                )}
                              </div>
